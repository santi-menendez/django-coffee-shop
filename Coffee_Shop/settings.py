...
SECRET_KEY = "django-insecure-g5wvne*pf^3-0_jgc672tu(!1s85$5j$^%^fy(%(gep8h9^exk"
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            os.path.join(
                BASE_DIR, "templates"
            ),  # Directorio de plantillas a nivel del proyecto
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
LOGIN_REDIRECT_URL = (
    "list_product"  # Redirige a la lista de productos después del inicio de sesión
)
LOGOUT_REDIRECT_URL = (
